...
/*-----------------------------------------------
              @(target):= _AssociatePythonWithSWIG.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__AssociatePythonWithSWIG

#else
#  define SWIG_init    init_AssociatePythonWithSWIG

#endif
#define SWIG_name    "_AssociatePythonWithSWIG"
